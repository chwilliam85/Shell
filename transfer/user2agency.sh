...
hive -S -v -e "
CREATE TABLE IF NOT EXISTS cm_ods_safe.${db_table} AS SELECT uid,lv10_aid,lv9_aid,lv8_aid,lv7_aid,lv6_aid,lv5_aid,lv4_aid,lv3_aid,lv2_aid,lv1_aid FROM cm_ods_mask.${db_table}_delta WHERE 1=2;

ALTER TABLE cm_ods_safe.${db_table} SET FILEFORMAT ORCFile;

INSERT OVERWRITE TABLE cm_ods_safe.${db_table} SELECT uid,lv10_aid,lv9_aid,lv8_aid,lv7_aid,lv6_aid,lv5_aid,lv4_aid,lv3_aid,lv2_aid,lv1_aid FROM cm_ods_mask.${db_table}_delta;

CREATE TABLE IF NOT EXISTS cm_ods_mask.${db_table} LIKE cm_ods_safe.${db_table};

INSERT OVERWRITE TABLE cm_ods_mask.${db_table} SELECT uid,lv10_aid,lv9_aid,lv8_aid,lv7_aid,lv6_aid,lv5_aid,lv4_aid,lv3_aid,lv2_aid,lv1_aid FROM cm_ods_mask.${db_table}_delta;
