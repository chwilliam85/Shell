...
hive -S -v -e "
CREATE TABLE IF NOT EXISTS cm_ods_safe.${db_table} AS SELECT aid,level,agency_lv1_aid,agency_lv2_aid,agency_lv3_aid,agency_lv4_aid,agency_lv5_aid,agency_lv6_aid,agency_lv7_aid,agency_lv8_aid,agency_lv9_aid,agency_lv10_aid FROM cm_ods_mask.${db_table}_delta WHERE 1=2;

ALTER TABLE cm_ods_safe.${db_table} SET FILEFORMAT ORCFile;

INSERT OVERWRITE TABLE cm_ods_safe.${db_table} SELECT aid,level,agency_lv1_aid,agency_lv2_aid,agency_lv3_aid,agency_lv4_aid,agency_lv5_aid,agency_lv6_aid,agency_lv7_aid,agency_lv8_aid,agency_lv9_aid,agency_lv10_aid FROM cm_ods_mask.${db_table}_delta;

CREATE TABLE IF NOT EXISTS cm_ods_mask.${db_table} LIKE cm_ods_safe.${db_table};

INSERT OVERWRITE TABLE cm_ods_mask.${db_table} SELECT aid,level,agency_lv1_aid,agency_lv2_aid,agency_lv3_aid,agency_lv4_aid,agency_lv5_aid,agency_lv6_aid,agency_lv7_aid,agency_lv8_aid,agency_lv9_aid,agency_lv10_aid FROM cm_ods_mask.${db_table}_delta;
